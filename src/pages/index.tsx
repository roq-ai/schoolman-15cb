  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Welcome to SchoolMan - Streamlining School Management with Comprehensive Solutions for Admissions, Student Records, Attendance, Progress Reports, and Parent Communication."
        />
      </Head>
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1497633762265-9d179a990aa6?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxzY2hvb2x8ZW58MHx8fHwxNjg5OTI1MDAyfDA&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Welcome to SchoolMan - Streamlining School Management with Comprehensive Solutions for Admissions, Student Records, Attendance, Progress Reports, and Parent Communication.`}
            </Text>
            <Box
